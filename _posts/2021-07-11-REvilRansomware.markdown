...
5. [Anti-Analysis: Dynamic API Resolving](#anti-analysis-dynamic-api-resolving)
6. [Anti-Analysis: String Encryption](#anti-analysis-string-encryption)
7. [Configuration](#configuration)
8. [Command-line Arguments](#command-line-arguments)
9. [Generate Victim Information](#generate-victim-information)
   9.1. [Victim Secret Key](#i-victim-secret-key)
   9.2. [Victim ID](#ii-victim-id)
   9.3. [Encrypted File Extension](#iii-encrypted-file-extension)
   9.4. [Full Victim Information Buffer](#iv-full-victim-information-buffer)
10. [Building Ransom Note](#building-ransom-note)
11. [Ransom Wallpaper Image](#building-ransom-wallpaper-image)
12. [Language Check](#language-check)
13. [Safemood Reboot](#safemood-reboot)
14. [Run-Once Mutex](#run-once-mutex)
15. [Priviledge Escalation](#priviledge-escalation)
16. [Pre-Encryption Setup](#pre-encryption-setup)
17. [Persistence](#persistence)
18. [Terminating Services and Processes through WMI](#terminating-services-and-processes-through-wmi)
19. [Terminating Services through Service Control Manager](#terminating-services-through-service-control-manager)
20. [Terminating Processes](#terminating-processes)
21. [Deleting Shadow Copies](#deleting-shadow-copies)
22. [File Encryption](#file-encryption)
    22.1. [Multithreading setup](#multithreading-setup)
    22.2. [Main Thread Traversal](#main-thread-traversal)
      * 22.2.1. [Checking Directory Name](#i-checking-directory-name)
      * 22.2.2. [Dropping Ransom Note](#ii-dropping-ransom-note)
      * 22.2.3. [Traversal](#iii-traversal)
      * 22.2.4. [Pre-Encryption File Setup](#iv-pre-encryption-file-setup)
    22.3. [Children Thread Encryption](#children-thread-encryption)
      * 22.3.1. [State 1: Reading File](#i-state-1-reading-file)
      * 22.3.2. [State 2. Encrypt and Write File](#ii-state-2-encrypt-and-write-file)
      * 22.3.3. [State 3. Write File Footer](#iii-state-3-write-file-footer)
      * 22.3.4. [State 4. Move File](#iv-state-4-move-file)
...
25. [File Decryption](#file-decryption)
    1.  [Operator Key](#i-operator-key)
    2.  [Campaign Key](#ii-campaign-key)
    3.  [Decrypting the Victim Information Buffer](#iii-decrypting-the-victim-information-buffer)
26. [Personal Opinion](#personal-opinion)
