...
However, unlike **BABUK** devs who are a big fan of using curves and eSTREAM portfolio Profile 1 ciphers such as ChaCha and HC-128 for hybrid-encryption, **ROOK** devs stick with the traditional choice of RSA and AES.
